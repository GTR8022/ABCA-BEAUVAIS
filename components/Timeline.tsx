...
const milestones = [
  ...
  },
  {
    year: '2025',
    title: 'L\'Empire',
    description: 'Plus de 30 dates par an. Une machine de guerre événementielle au service du divertissement populaire. Son, Lumières, Ambiance survoltée : l\'ABCA est aujourd\'hui la référence incontournable du catch en Hauts-de-France.',
