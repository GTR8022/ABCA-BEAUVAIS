...
export const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // La demande passe par notre propre fonction serveur (api/contact.js),
      // qui envoie le mail depuis contact@catchfrancais.fr. Un expediteur sur
      // notre domaine, signe DKIM, n'est plus classe en indesirable par AOL.
      ...
      if (response.ok) {
        ...
        const { erreur } = await response.json().catch(() => ({ erreur: '' }));
        alert(erreur || "Une erreur est survenue. Veuillez réessayer ou nous contacter par téléphone.");
        setFormStatus('idle');
      }
    } catch (error) {
            ...
            <ScrollReveal>
              <div>
                ...
                <div className="flex space-x-4 mt-8 mb-8">
                  <a href="https://www.facebook.com/ABCAcatch/?locale=fr_FR" target="_blank" rel="noopener noreferrer" className="bg-neutral-800 p-3 rounded-full text-white hover:bg-[#1877F2] transition-all duration-300 border border-neutral-700 hover:scale-110 shadow-lg" aria-label="Facebook ABCA">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.791-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/abcacatch/" target="_blank" rel="noopener noreferrer" className="bg-neutral-800 p-3 rounded-full text-white hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] transition-all duration-300 border border-neutral-700 hover:scale-110 shadow-lg" aria-label="Instagram ABCA">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-3.99-1.789-3.99-3.99s1.781-3.99 3.99-3.99 3.99 1.781 3.99 3.99-1.781 3.99-3.99 3.99zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                    </svg>
                  </a>
                </div>

                {/* International Booking Block */}
                <div className="bg-neutral-900 border border-neutral-700 p-6 w-full text-left relative overflow-hidden group hover:border-abca-gold transition-colors z-10">
                  ...
                  <a
                    href="mailto:GRIGNONcatchABCA@aol.com"
                    className="relative z-30 inline-block text-white text-xs font-bold uppercase border-b border-white hover:text-abca-red hover:border-abca-red transition-colors"
                  >
            ...
            <ScrollReveal delay={200}>
              ...
              {formStatus === 'success' ? (
                <div className="flex flex-col items-center justify-center h-[400px] text-center animate-fade-in">
                  ...
                  <p className="text-gray-400">Merci de votre intérêt. Notre équipe vous recontactera prochainement pour finaliser votre projet.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  {/* L'objet du mail, le modele et le destinataire sont geres
                      cote serveur dans api/contact.js. */}

                  {/* Piege a robots : invisible pour un humain, rempli par les bots.
                      Le serveur ignore silencieusement ces envois. */}
                  <input
                    type="text"
                    name="_honey"
                    tabIndex={-1}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input id="f-date" type="date" name="date" className="w-full bg-neutral-800 border border-neutral-700 text-white px-4 py-3 focus:outline-none focus:border-abca-red focus:ring-1 focus:ring-abca-red transition-all text-gray-400" />
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <select id="f-public" name="public" className="w-full bg-neutral-800 border border-neutral-700 text-white px-4 py-3 focus:outline-none focus:border-abca-red focus:ring-1 focus:ring-abca-red transition-all appearance-none">
