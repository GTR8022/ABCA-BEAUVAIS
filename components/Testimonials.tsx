...
const testimonials = [
  {
    ...
    blason: "/images/blasons/crevecoeur.svg"
  },
  {
    city: "Bresles",
    role: "Mairie",
    ...
    blason: "/images/blasons/bresles.svg"
  },
  {
    city: "Noailles",
    role: "Organisateur",
    ...
    blason: "/images/blasons/noailles.svg"
  }
];
            ...
            <ScrollReveal key={index} delay={index * 150}>
              <div className="bg-neutral-900 border border-neutral-800 p-8 relative rounded-sm hover:border-abca-red transition-colors duration-300 group">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-neutral-700 bg-white p-1">
                    <img src={item.blason} alt={`Blason ${item.city}`} className="w-full h-full object-contain" />
                  </div>
                  <div>
